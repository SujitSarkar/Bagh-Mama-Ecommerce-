...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin,TickerProviderStateMixin{
  ...
  Future<void> _customInit(ThemeProvider themeProvider,APIProvider apiProvider,DatabaseHelper databaseHelper)async{
    ...
    if(apiProvider.newArrivalProductModel==null) await apiProvider.getNewArrivalProducts({"product_limit":51,"sort":"2"});
    if(apiProvider.popularProductModel==null) await apiProvider.getPopularProducts({"product_limit":51,"sort":"1"});
    if(apiProvider.allProductModel==null) await apiProvider.getAllProducts({"product_limit":51});
  ...
  Widget build(BuildContext context) {
    ...
    return themeProvider.internetConnected? Stack(
      children: [
        Scaffold(
          ...
          body: _tabIndex==0? _bodyUI_1(size,themeProvider,apiProvider,databaseHelper)
              : _bodyUI_2(size, themeProvider,apiProvider),
        ),

        apiProvider.campaignsDateModel!=null? Positioned(
            left : position.dx,
            top  : position.dy,
            child : Draggable(
                feedback: Container(
                ...
                child: InkWell(
                  onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>CampaignsListPage())),
                  child: Column(
                    children: [
                      Container(
                        height: 40,
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            ///Image Slider
            apiProvider.networkImageList.isNotEmpty? Container(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=>NewArrivalProductList())),
                    child: Text('View All',
            ...
            apiProvider.newArrivalProductModel!=null?Container(
              padding: EdgeInsets.symmetric(horizontal: 10),
              child: GridView.builder(
                ...
                shrinkWrap: true,
                itemCount: apiProvider.newArrivalProductModel.content.length>6?6
            ...
            SizedBox(height: size.width*.03),
            apiProvider.popularProductModel!=null? Container(
              padding: EdgeInsets.symmetric(horizontal: 10),
              child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 3,
                ...
                physics: ClampingScrollPhysics(),
                shrinkWrap: true,
                itemCount: apiProvider.popularProductModel.content.length>6?6
            ...
            apiProvider.allProductModel!=null
              ...
              child: GridView.builder(
                ...
                shrinkWrap: true,
                physics: ClampingScrollPhysics(),
                itemCount: apiProvider.allProductModel.content.length>102?102
  ...
  Widget _bodyUI_2(Size size, ThemeProvider themeProvider,APIProvider apiProvider)=> NotificationListener(
    onNotification: (scrollNotification) {
      if (_scrollController.position.userScrollDirection ==
          ScrollDirection.reverse) {
        setState(() {
