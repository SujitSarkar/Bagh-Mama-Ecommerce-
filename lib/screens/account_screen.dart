...
class _AccountScreenState extends State<AccountScreen> {
  ...
  void _customInit(ThemeProvider themeProvider, APIProvider apiProvider,
  ...
  Widget build(BuildContext context) {
    ...
    if (_counter == 0 && themeProvider.internetConnected)
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: themeProvider.internetConnected
            ? _bodyUI(size, themeProvider, apiProvider, databaseHelper)
            : NoInternet(),
        floatingActionButton: Builder(
          builder: (context) =>
              _floatingActionButton(size, themeProvider, apiProvider),
        ),
      ),
    );
  }
                        ...
                        children: [
                                  ...
                                  child: apiProvider.userInfoModel != null
                                      ? ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: apiProvider.userInfoModel
                                                .content.profilePic,
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(
                                                text:
                                                    '${apiProvider.userInfoModel.content.firstName} ${apiProvider.userInfoModel.content.lastName}\n',
                                                style: TextStyle(
                                            ...
                                            TextSpan(
                                                text:
                                                    '${apiProvider.userInfoModel.content.email}\n'),
                                            TextSpan(
                                                text:
                                                    '${apiProvider.userInfoModel.content.mobileNumber}\n\n'),
                                            TextSpan(
                                                text: 'Address: ',
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.w500)),
                                            apiProvider.userInfoModel.content
                                                    .address.isNotEmpty
                                                ? TextSpan(
                                                    text:
                                                        '${apiProvider.userInfoModel.content.address}\n')
                                                : TextSpan(),
                                            TextSpan(
                                                text: 'City: ',
                                                style: TextStyle(
                                            ...
                                            apiProvider.userInfoModel.content
                                                ...
                                                ? TextSpan(
                                                    text:
                                                        '${apiProvider.userInfoModel.content.city}\n')
                                                : TextSpan(),
                                            TextSpan(
                                                text: 'State: ',
                                                style: TextStyle(
                                            ...
                                            apiProvider.userInfoModel.content
                                                ...
                                                ? TextSpan(
                                                    text:
                                                        '${apiProvider.userInfoModel.content.state}\n')
                                                : TextSpan(),
                                            TextSpan(
                                                text: 'Postal Code: ',
                                                style: TextStyle(
                                            ...
                                            apiProvider.userInfoModel.content
                                                ...
                                                ? TextSpan(
                                                    text:
                                                        '${apiProvider.userInfoModel.content.postalcode}\n')
                                                : TextSpan(),
                                            apiProvider.userInfoModel.content
                                                    .country.isNotEmpty
                                                ? TextSpan(
                                            ...
                                            apiProvider.userInfoModel.content
                                                ...
                                                ? TextSpan(
                                                    text:
                                                        '${apiProvider.userInfoModel.content.country}\n')
                                                : TextSpan(),
                                          ],
                                        ),
                                      ),
                          ...
                          apiProvider.userInfoModel != null
                              ? Row(
                                  ...
                                  children: [
                                    _buttonBuilder(themeProvider, apiProvider,
                                        size, Icons.camera_alt),
                                    SizedBox(width: size.width * .03),
                                    _buttonBuilder(themeProvider, apiProvider,
                                        size, Icons.edit),
                                    SizedBox(width: size.width * .03),
                                    _buttonBuilder(themeProvider, apiProvider,
                                        size, Icons.vpn_key_sharp),
                                  ],
                                )
                              : Container()
                        ],
  ...
  Future<void> _getImageFromGallery(
      ThemeProvider themeProvider, APIProvider apiProvider) async {
    ...
    if (pickedFile != null) {
      ...
      await apiProvider
          .requestWithFile(files: _image, fileKey: 'ppic')
          .then((value) async {
        if (value) {
          await apiProvider.getUserInfo(pref.getString('username'));
          closeLoadingDialog();
      ...
      showSnackBar(context, 'No image selected!', themeProvider);
  }

  Widget _buttonBuilder(ThemeProvider themeProvider, APIProvider apiProvider,
          Size size, IconData iconData) =>
      Container(
        width: size.width * .12,
        ...
        child: TextButton(
          ...
          onPressed: () async {
            ...
            } else if (iconData == Icons.vpn_key_sharp)
  ...
  Widget _functionBuilder(
      ...
      ListTile(
        onTap: () async {
          ...
          else if (name == 'Change Currency')
            _selectCurrency(themeProvider, size);
          else if (name == 'WishLists')
            Navigator.push(context,
      ...
      FabCircularMenu(
        ...
        children: <Widget>[
          ...
          RawMaterialButton(
            onPressed: () {
              _launchSocialApp(
                  'sms:${apiProvider.basicContactInfo.content.mobile2}');
          ...
          RawMaterialButton(
            onPressed: () {
              _launchSocialApp(
                  'mailto:${apiProvider.basicContactInfo.content.email}'
          ...
          RawMaterialButton(
            onPressed: () {
              _launchSocialApp(
                  'whatsapp://send?phone=${apiProvider.basicContactInfo.content.mobile2}'
          ...
          RawMaterialButton(
            onPressed: () {
              _launchSocialApp(
                  'tel:${apiProvider.basicContactInfo.content.mobile2}');
              fabKey.currentState.close();
            },
            shape: CircleBorder(),
            padding: EdgeInsets.all(20.0),
