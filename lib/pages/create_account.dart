              ...
              children: [
                ...
                Container(
                  padding: EdgeInsets.symmetric(
                      vertical: size.width * .01, horizontal: size.width * .03),
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      isExpanded: true,
                      isDense: true,
                      hint: Text("Select Division/State",
                          style: TextStyle(
                    ...
                    ? Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            isExpanded: true,
                            isDense: true,
                            hint: Text("Select District/City",
                                style: TextStyle(
                                    color: Colors.grey,
                                    fontSize: size.width * .04)),
                            onChanged: (value) async {
